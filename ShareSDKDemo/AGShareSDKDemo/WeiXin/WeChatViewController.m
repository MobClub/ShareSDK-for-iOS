...
- (void)sendAppContent
{
    ...
    id<ISSContent> content = [ShareSDK content:@"你看不懂啊， 看不懂啊， 看不懂！"
                                defaultContent:nil
...
{
    id<ISSContent> content = [ShareSDK content:@"只能说胡戈是中国广告界的一朵奇葩！！！这次真的很多人给跪了、、、"
                                defaultContent:nil
                                         image:[ShareSDK jpegImageWithImage:[UIImage imageNamed:@"res2.jpg"] quality:1]
                                         title:@"步步惊奇"
...
- (void)viewDidLoad
{
    ...
    [btn21 setTitle:@"发送文本消息给微信" forState:UIControlStateNormal];
    ...
    [btn22 setTitle:@"发送Photo消息给微信" forState:UIControlStateNormal];
    ...
    [btn23 setTitle:@"发送Music消息给微信" forState:UIControlStateNormal];
    ...
    [btn24 setTitle:@"发送News消息给微信" forState:UIControlStateNormal];
    ...
    [btn25 setTitle:@"发送Video消息给微信" forState:UIControlStateNormal];
    ...
    [btn26 setTitle:@"发送App消息给微信" forState:UIControlStateNormal];
    ...
    [btn27 setTitle:@"发送非gif消息给微信" forState:UIControlStateNormal];
    ...
    [btn20 setTitle:@"发送gif消息给微信" forState:UIControlStateNormal];
    ...
    [btn28 setTitle:@"发送文本消息给微信" forState:UIControlStateNormal];
    ...
    [btn29 setTitle:@"发送Photo消息给微信" forState:UIControlStateNormal];
    ...
    [btn30 setTitle:@"发送Music消息给微信" forState:UIControlStateNormal];
    ...
    [btn31 setTitle:@"发送News消息给微信" forState:UIControlStateNormal];
    ...
    [btn32 setTitle:@"发送Video消息给微信" forState:UIControlStateNormal];
    ...
    [btn33 setTitle:@"发送App消息给微信" forState:UIControlStateNormal];
    ...
    [btn34 setTitle:@"发送非gif消息给微信" forState:UIControlStateNormal];
    ...
    [btn35 setTitle:@"发送gif消息给微信" forState:UIControlStateNormal];
