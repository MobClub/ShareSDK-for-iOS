 ...
 *	@brief	笔记属性列表
 */
@interface SSEverNoteNoteAttributes : SSCDataObject
 ...
 *	@return	笔记属性类表对象
 */
+ (SSEverNoteNoteAttributes *)noteAttributesWithResponse:(id<ISSEverNoteDataOutput>)reader;
