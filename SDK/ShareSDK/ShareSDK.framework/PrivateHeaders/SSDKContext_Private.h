 ...
 */
@property (nonatomic, strong) NSMutableArray *applicationClassesArray;
...
/**
 授权界面 非web传入原生界面进行授权 (暂时短信专用)

 @param authViewController 原生授权 viewController
 @param sessionId 传入sessionId
 */
- (void)showAuthWithAuthViewController:(SSDKContentViewController *)authViewController sessionId:(NSString *)sessionId;

//微博网页回调添加的hook状态
@property (nonatomic) BOOL isAddOpenURL;
@end
