...
/// @param myStoryId 내스토리 정보(storyGetMyStoryTaskWithMyStoryId:completionHandler:)의 포스트 id (required)
...
/// @abstract 카카오스토리의 복수개의 내스토리 정보들을 얻을 수 있습니다. 단, comments, likes등의 상세정보는 없으며 이는 내스토리 정보 요청(storyGetMyStoryTaskWithMyStoryId:completionHandler:)을 통해 얻을 수 있습니다.
/// @param lastMyStoryId 복수개의 내스토리 정보들을 얻기 위한 가장 최근의 내스토리 정보(storyGetMyStoryTaskWithMyStoryId:completionHandler:)의 포스트 id. 주어진 id의 시간을 기준으로 해당 id를 제외한 약 18개정도의 하위 myStory들이 반환된다. (optional)
...
/// @param permission 공개 범위 KOStoryPostPermission (default public. optional)
/// @param sharable permission이 친구 공개에 한해서 공유를 허용할지 안할지의 여부 (default NO. optional)
...
/// @param imageUrls 이미지 url들을 포함한 array (required)
/// <br>storyMultiImageUploadTaskWithImages:completionHandler: 호출 후 반환되는 url들을 설정해야 합니다.
