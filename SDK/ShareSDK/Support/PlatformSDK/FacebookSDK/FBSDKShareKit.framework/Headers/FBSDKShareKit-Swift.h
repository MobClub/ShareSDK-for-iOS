...
@property (nonatomic, readonly) BOOL canShow;
- (BOOL)show;
- (BOOL)showAutomaticAndReturnError:(NSError * _Nullable * _Nullable)error;
- (BOOL)showBrowserAndReturnError:(NSError * _Nullable * _Nullable)error;
- (BOOL)showFeedBrowserAndReturnError:(NSError * _Nullable * _Nullable)error;
- (BOOL)showFeedWebAndReturnError:(NSError * _Nullable * _Nullable)error;
- (BOOL)showNativeAndReturnError:(NSError * _Nullable * _Nullable)error;
- (BOOL)showShareSheetAndReturnError:(NSError * _Nullable * _Nullable)error;
- (BOOL)showWebAndReturnError:(NSError * _Nullable * _Nullable)error;
- (BOOL)validateWithError:(NSError * _Nullable * _Nullable)error;
@end
