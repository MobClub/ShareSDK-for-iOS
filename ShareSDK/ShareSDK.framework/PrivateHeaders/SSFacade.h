...
@private
    ...
    SSAwardObtainCoinsHandler _obtainCoinsHandler;
    SSAwardBuyItemHandler _buyItemHandler;
 ...
 *	@param 	coins 	金币数量
 */
- (void)postObtainCoinsEventWithAction:(SSObtainCoinsAction)action
 ...
 *	@param 	errMsg 	错误消息
 */
- (void)postBuyItemEventWithState:(SSResponseState)state
