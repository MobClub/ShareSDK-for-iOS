...
///#begin en
/**
 *	@brief	Credential，If non-nil indicates that the current authorized user
 */
///#end
...
///#begin en
/**
 *	@brief	Users of the original data, Information structure with the same user-defined for each platform
 */
///#end
