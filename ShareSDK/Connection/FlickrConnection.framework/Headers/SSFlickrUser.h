 ...
 */
///#end
@interface SSFlickrUser : NSObject <ISSPlatformUser,
                                    NSCoding,
                                    ISSCDataObject>
///#begin zh-cn
/**
...
///#begin en
/**
 *	@brief	Authorization information. if it is nil, said non-current applications to authorized users
 */
///#end
...
///#begin en
/**
 *	@brief	The number of users to share
 */
///#end
...
///#begin en
/**
 *	@brief	Education information list.
 */
///#end
