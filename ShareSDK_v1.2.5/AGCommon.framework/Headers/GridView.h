 ...
 *	@param 	index 	位置索引
 */
- (void)gridView:(GridView *)gridView
    itemRenderer:(UIView<IGridItemView> *)itemRenderer
 ...
 */
- (void)gridViewDidEndDragging:(GridView *)gridView willDecelerate:(BOOL)decelerate;
 ...
 *	@param 	cell 	页脚项
 */
- (void)gridView:(GridView *)gridView footerWillDisplay:(UITableViewCell *)cell;
 ...
 *	@param 	cell 	页脚项
 */
- (void)gridView:(GridView *)gridView footerDidSelected:(UITableViewCell *)cell;
...
/**
	表格视图
 */
@interface GridView : UIView <UITableViewDataSource,
                              UITableViewDelegate,
