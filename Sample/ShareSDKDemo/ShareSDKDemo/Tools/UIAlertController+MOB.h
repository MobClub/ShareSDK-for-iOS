...
typedef void (^ mobAlertTapBlock)(NSInteger index, UIAlertAction *action);
@interface UIAlertController (MOB)
/**
 ...
 */
@property (nonatomic, copy, readonly) UIAlertController * (^ actionTap) (mobAlertTapBlock tapIndex);
...
@end
@interface UIAlertAction (DPCategory)
