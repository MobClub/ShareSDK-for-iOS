//
//  MOBYixinfavoritesViewController.m
//  ShareSDKDemo
//
...
#import "MOBYixinfavoritesViewController.h"

@implementation MOBYixinfavoritesViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    platformType = SSDKPlatformSubTypeYiXinFav;
    self.title = @"易信收藏";
